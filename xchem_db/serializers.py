...
class FragspectCrystalSerializer(serializers.ModelSerializer):
    ...
    self.refinement = self.obj.current_refinement
    self.dataproc = self.obj.current_dataproc
    ...
    crystal_status = serializers.CharField(source='current_refinement.outcome')
    # event_status = serializers.SerializerMethodField()
    confidence = serializers.CharField(source='ligand_confidence')
    crystal_resolution = serializers.CharField(source='current_refinement.res')
    ...
    cell = serializers.CharField(source='current_dataproc.unit_cell')
