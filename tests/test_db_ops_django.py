...
#         self.assertTrue(transfer)
    ...
    #     self.assertEqual(int(status[0]), 2)
        ...
        #
        # ref_or_above = Refinement.objects.filter(
        ...
        #
        #     hits_dict['crystal_name'].append(lab_entry.crystal_name)
        #     hits_dict['protein'].append(lab_entry.protein)
        #     hits_dict['smiles'].append(lab_entry.compound)
        #     hits_dict['strucid'].append('')
        #     hits_dict['bound_conf'].append('')
        #     hits_dict['modification_date'].append('')
        #
        # print(hits_dict)
